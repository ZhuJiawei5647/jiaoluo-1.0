...
//            if (ele.distanceX > winWidth/2) {$(ele).addClass('right')}
        ...
        document.addEventListener('touchend', function () {
            ...
            var step = function () {
                ...
                if (moveX < 0 && bound.left + moveX < 0) {
                    ...
                    // 碰触边缘方向反转
                    reverseX = reverseX * -1;
                } else if (moveX > 0 && bound.right + moveX > winWidth - 0) {
                    moveX = winWidth - 0 - bound.right;
                    reverseX = reverseX * -1;
                }
            ...
            var edge = function () {
                ...
                if (bound.left + bound.width / 2 < winWidth / 2) {
                    change = -1 * (bound.left - 20);
                    $(ele).removeClass('right')
                } else {
                    change = winWidth - (bound.right + 20);
                    $(ele).addClass('right')
                }
